...
BASE_STRINGS = [
    ...
    "There is currently no description for this annotation. Please help us by `contributing one <https://github.com/Nokorpo/gato-godot-accessibility-toolkit>`__!",
    ...
    "There is currently no description for this constructor. Please help us by `contributing one <https://github.com/Nokorpo/gato-godot-accessibility-toolkit>`__!",
    ...
    "There is currently no description for this operator. Please help us by `contributing one <https://github.com/Nokorpo/gato-godot-accessibility-toolkit>`__!",
    "There is currently no description for this theme property. Please help us by `contributing one <https://github.com/Nokorpo/gato-godot-accessibility-toolkit>`__!",
...
class State:
    ...
    def parse_class(self, class_root: ET.Element, filepath: str) -> None:
        ...
        class_name = class_name.replace('&quot;', '').replace('./', '').replace('/', '_').replace('"', '')
        ...
        if inherits is not None:
            class_def.inherits = inherits.replace('&quot;', '').replace('./', '').replace('/', '_').replace('"', '')
